...
INSERT INTO `mydb`.`FOOD_CATEGORY` (`CATEGORY_ID`, `CATEGORY_DESCRIPTION`) VALUES (10, 'Mediterranean');
INSERT INTO `mydb`.`FOOD_CATEGORY` (`CATEGORY_ID`, `CATEGORY_DESCRIPTION`) VALUES (11, 'American');
INSERT INTO `mydb`.`FOOD_CATEGORY` (`CATEGORY_ID`, `CATEGORY_DESCRIPTION`) VALUES (12, 'British');
INSERT INTO `mydb`.`FOOD_CATEGORY` (`CATEGORY_ID`, `CATEGORY_DESCRIPTION`) VALUES (13, 'African');
INSERT INTO `mydb`.`FOOD_CATEGORY` (`CATEGORY_ID`, `CATEGORY_DESCRIPTION`) VALUES (14, 'Vietnamiese');
INSERT INTO `mydb`.`FOOD_CATEGORY` (`CATEGORY_ID`, `CATEGORY_DESCRIPTION`) VALUES (15, 'Turkish');
INSERT INTO `mydb`.`FOOD_CATEGORY` (`CATEGORY_ID`, `CATEGORY_DESCRIPTION`) VALUES (16, 'Polish');
